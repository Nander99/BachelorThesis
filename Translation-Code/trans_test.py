...
def evaluate_model(model, tokenizer, sources, raw_dataset):
    ...
    for i, source in enumerate(sources):
        ...
        translation_list.append([raw_src, raw_target, translation])
...
test = load_clean_dataset('Translation-Pickle-Files/old-new-test.pkl')
...
save_clean_data(translations, 'Test-Data/translated-old-new-test-data.pkl')
